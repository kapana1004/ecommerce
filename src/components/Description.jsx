...
export default function Description({ item, setItem, priceHandle, activAdd }) {
  ...
  return (
    <div className=" xl:pl-[90px] xl:w-[445px] xl:mt-[132px]">
      <span className=" text-[12px]  pl-[24px] text-[#FF7E1B] font-sans font-bold xl:texst-[13px] ">
        SNEACKER COMPANY
      </span>
      <h1 className=" text-[28px] font-sans font-bold w-[327px] pl-[24px] leading-8 mt-[19px] xl:text-[48px] xl:leading-[48px] xl:w-[445px] ">
        {" "}
      ...
      <div className=" xl:flex xl:flex-row">
        <div
          ...
          rounded-[10px] bg-[#F6F8FD] w-[327px] h-[56px] mt-[26px] mb-[16px] xl:w-[157px]"
        >
          <img
